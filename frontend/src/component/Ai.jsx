...
window.speechSynthesis.speak(utterence)
 ...
 if(transcript.toLowerCase().includes("search") && transcript.toLowerCase().includes("open") && !showSearch){
     ...
     else if(transcript.toLowerCase().includes("process")  || transcript.toLowerCase().includes("process")  || transcript.toLowerCase().includes("process")){
      speak("opening your processing and cart Page")
      navigate("/cart")
      setShowSearch(false) 
    }
